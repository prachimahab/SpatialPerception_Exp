...
setwd("")
df_subj <- read.csv('data/groundPlane_participantData_for_lme.csv')
df_subj$subjID <- factor(df_subj$subjID) 
df_subj$duration <- factor(df_subj$duration)
df_subj$stimulus <- factor(df_subj$stimulus) 

df <- read.csv('data/groundPlane_data_for_lme.csv')
df$duration <- factor(df$duration)
df$stimulus <- factor(df$stimulus) 

df_grouped <- read.csv('data/groundPlane_participantData_grouped_for_lme.csv')
