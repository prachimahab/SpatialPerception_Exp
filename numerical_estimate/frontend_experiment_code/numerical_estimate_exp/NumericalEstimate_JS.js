...
// information flow: experimentLink_variables.csv --> url for participant --> counterbalancing csv indexed by url fragment --> sampled json path
// experimentLink_variables.csv is uploaded when publishing a batch --> This contains the url for each participant 
...
// practice sequence is  8 trials with 2 catch trials (image with no target)
...
// 162 trials in a full experiment 
var num_trials = 163 // since indexing starts at zero num_trial = actual total trials - 1
